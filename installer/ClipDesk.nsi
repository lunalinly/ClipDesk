Unicode true
Name "ClipDesk"
OutFile "..\dist\ClipDesk-Setup-1.1.0-x64.exe"
...
Section "ClipDesk" SEC_MAIN
  SetOutPath "$INSTDIR"
  File /oname=ClipDesk.exe "..\dist\ClipDesk-Portable-1.1.0-x64.exe"
  ...
  WriteRegStr HKCU "Software\Microsoft\Windows\CurrentVersion\Uninstall\ClipDesk" "DisplayVersion" "1.1.0"
